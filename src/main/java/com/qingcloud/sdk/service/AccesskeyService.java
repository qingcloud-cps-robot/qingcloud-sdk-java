...
public class AccesskeyService {
    ...
    /**
      * @param input Request parameters and headers in the class
      * @return DescribeAccessKeyOutput Response body and headers in the class
      * @throws QCException IOException or network error
      *
      * <a href=>Documentation URL</a>
      */
    @SuppressWarnings({"rawtypes", "unchecked"})
    public DescribeAccessKeyOutput describeAccessKey(DescribeAccessKeyInput input) throws QCException {
        if (input == null) {
            input = new DescribeAccessKeyInput();
        }
        Map context = new HashMap();
        context.put(QCConstant.ENV_CONTEXT_KEY, this.envContext);
        context.put("OperationName", "DescribeAccessKey");
        context.put("APIName", "DescribeAccessKey");
        context.put("ServiceName", "DescribeAccessKey");
        context.put("RequestMethod", "GET");
        context.put("RequestURI", "/iaas/DescribeAccessKeys");

        input.setAction("DescribeAccessKey");
        if (QCStringUtil.isEmpty(this.zone)) {
            input.setZone(this.envContext.getZone());
        } else {
            input.setZone(this.zone);
        ...
        Object backModel = ResourceRequestFactory.getResourceRequest().sendApiRequest(context, input,DescribeAccessKeyOutput.class);
        if(backModel != null){
            return (DescribeAccessKeyOutput)backModel;
        }
        return null;
    }
     ...
     /**
       ...
       */
    @SuppressWarnings({"rawtypes", "unchecked"})
    public void describeAccessKey(DescribeAccessKeyInput input, ResponseCallBack<DescribeAccessKeyOutput> callback) throws QCException {
        if (input == null) {
            input = new DescribeAccessKeyInput();
        }
        Map context = new HashMap();
    ...
    public static class DescribeAccessKeyInput extends IaasParamBody {
        private List<String> accessKeys;
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public static class DescribeAccessKeyOutput extends OutputModel {
